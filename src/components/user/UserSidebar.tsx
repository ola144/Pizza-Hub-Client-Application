...
export function UserSidebar({
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex min-h-screen w-72 flex-col bg-[#2b1b14] px-5 py-6 text-[#fffaf5] transition-transform lg:translate-x-0 ${open ? "translate-x-0" : "-translate-x-full"}`}
      >
